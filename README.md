...
| resolutionScaleType?                | GamingCanvasResolutionScaleType or GamingCanvasResolutionScaleType[] | `ANTIALIAS` | Set the scaling style(s) of canvas(es) to the container element's dimensions                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
