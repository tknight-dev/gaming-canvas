...
```typescript
import { GamingCanvas, GamingCanvasScaleType, GamingCanvasSetSize } from '@tknight-dev/gaming-canvas';
...
const canvases: HTMLCanvasElement[] = GamingCanvas.initialize(container, {
    resolutionByWidthPx: 640, // Default aspect ratio is 16/9 so the final fixed dimensions are 640x320 (like Youtube's 320p) and will never change
    scaleType: GamingCanvasScaleType.PIXELATED, // PIXELATED for chunky 8bit styled upscaling of fixed resolution to fill the container element
});
...
| resolutionByWidthPx?                | number or `null`                                 | `null`      | `null` sets the canvas dimensions, and not `null` scales the canvas dimensions to fit                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| resolutionScaleToFit?               | boolean                                          | true        | Enables the scalling feature of `resolutionByHeightPx` when using a non-null value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| scaleType?                          | GamingCanvasScaleType or GamingCanvasScaleType[] | `ANTIALIAS` | Set the scaling style(s) of canvas(es) to the container element's dimensions                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
## Models: GamingCanvasScaleType (enum)

| Key       | Description                 |
| --------- | --------------------------- |
| ANTIALIAS | Smooth high quality image   |
| CRISP     | Preserve edges and contrast |
